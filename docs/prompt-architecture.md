...
The named V1 constant and dedicated module provide a clear location for future versions. Version registry, selection and prompt evaluation infrastructure remain future tasks.
